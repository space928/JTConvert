namespace JTConvert.JTCodec
{
    internal static class JTObjectTypeIdentifiers
    {
        ...
        public static readonly Dictionary<Type, GUID> ObjectTypeIdentifiers = new()
        {
            ...
            { typeof(JTNullShapeLODElement),                        new(0x3e637aed, 0x2a89, 0x41f8, 0xa9, 0xfd, 0x55, 0x37, 0x37, 0x3, 0x96, 0x82) },
            { typeof(JTPointSetShapeLODElement),                    new(0x98134716, 0x0011, 0x0818, 0x19, 0x98, 0x08, 0x00, 0x09, 0x83, 0x5d, 0x5a) },
            { typeof(JTPolylineSetShapeLODElement),                 new(0x10dd10a1, 0x2ac8, 0x11d1, 0x9b, 0x6b, 0x00, 0x80, 0xc7, 0xbb, 0x59, 0x97) },
            { typeof(JTPrimitiveSetShapeElement),                   new(0xe40373c2, 0x1ad9, 0x11d3, 0x9d, 0xaf, 0x00, 0xa0, 0xc9, 0xc7, 0xdd, 0xc2) },
            { typeof(JTTriStripSetShapeLODElement),                 new(0x10dd10ab, 0x2ac8, 0x11d1, 0x9b, 0x6b, 0x00, 0x80, 0xc7, 0xbb, 0x59, 0x97) },
            { typeof(JTPolygonSetShapeLODElement),                  new(0x10dd109f, 0x2ac8, 0x11d1, 0x9b, 0x6b, 0x00, 0x80, 0xc7, 0xbb, 0x59, 0x97) },
            //{ typeof(JTVertexShapeLODElement),                      new(0x10dd10b0, 0x2ac8, 0x11d1, 0x9b, 0x6b, 0x00, 0x80, 0xc7, 0xbb, 0x59, 0x97) },
